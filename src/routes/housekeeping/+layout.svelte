<script lang="ts">
  ...
  import { House, FilmReel, Layout, Books, Waveform, CloudArrowDown } from 'phosphor-svelte';
  ...
  const TABS: Tab[] = [
    ...
    { id: 'deezer-sync', label: 'Deezer Sync', href: '/housekeeping/deezer-sync',  Icon: CloudArrowDown }
  ];
